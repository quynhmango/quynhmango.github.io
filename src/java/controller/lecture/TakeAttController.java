...
public class TakeAttController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        int sesid = Integer.parseInt(request.getParameter("sid"));
        ...
        //response.getWriter().print(attDB);
        request.getRequestDispatcher("teacher_ass/take-attendance.jsp").forward(request, response);
